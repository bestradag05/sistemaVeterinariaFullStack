    ...
    <>
      ...
      <div className="flex justify-center">
        <div className="w-full md:w-1/2 bg-white shadow-sm rounded-lg p-5">
          ...
          >
            <div className="my-3">
              <label htmlFor="nombre" className="uppecase font-bold text-gray-600">Password Actual</label>
            ...
            <div className="my-3">
              <label htmlFor="nombre" className="uppecase font-bold text-gray-600">Password Nuevo</label>
